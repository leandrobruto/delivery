                ...
                <tbody>
                  ...
                  <tr>
                    <td align="center" valign="top" class="header-logo" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:10px 50px 30px;">
                      <!-- // Logo block // -->
                      <a href="http://mandadelivery.000webhostapp.com" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#4DC3C9;text-decoration:none;"><img src="https://link-to-your-hosted-image.png" alt="Food Delivery" width="146" height="30" style="-ms-interpolation-mode: bicubic; border: 0; display: block; max-width: 100%; outline: none; text-decoration: none; vertical-align: middle; width: auto"></a>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" valign="top" class="header" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#23179f url('https://link-to-another-hosted-image.png') repeat-y top;background-size:560px 150px;border-radius:5px 5px 0 0;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:28px 130px;" bgcolor="#3F3D55">
                      <!-- // Header block // -->
                        ...
                        <tbody>
                          <tr>
                            <td align="center" valign="middle" class="mobile-centered-container" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;">
                              <h1 class="header-heading mobile-centered-item" style="color:#fff;font-size:24px;letter-spacing:-.43px;line-height:30px;margin:0;padding:0 0 20px;">Redefinição de senha</h1>
                              <div>
                                <p class="header-text mobile-centered-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#fff;font-size:11px;line-height:14px;margin:0;padding-bottom:0;">
                                  <a href="http://mandadelivery.000webhostapp.com" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:#ffffff !important;text-decoration:none;"><strong>Food Delivery</strong></a>
                                  <span style="padding: 0 11px 0 10px">|</span>Sua plataforma de delivery
                                  </p>
                                </div>
                              </td>
                            </tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="left" valign="top" class="content-item" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                ...
                                Mussum Ipsum, cacilds vidis litro abertis. Todo mundo vê os porris que eu tomo, mas ninguém vê os tombis que eu levo!Copo furadis é disculpa de bebadis, arcu quam euismod magna.Per aumento de cachacis, eu reclamis.Atirei o pau no gatis, per gatis num morreus.</td>
                            </tr>
                          </tbody>
                        </table>
                          ...
                          <tbody>
                            <tr>
                              <td align="center" valign="middle" class="btn-content" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:#23179F;border:2px solid white;border-radius:30px;color:#fff;mso-table-lspace:0pt;mso-table-rspace:0pt;padding:4px 20px;" bgcolor="#A2F4DF">
                                <a href="/blog/cc-bcc-in-smtp" target="_blank" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;color:white !important;display:block;font-family:Arial, sans-serif;font-size:13px;font-weight:bold;text-decoration:none;">Redefinir</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center" valign="top" class="footer-heading" style="-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;background:url('https://gallery.mailchimp.com/bfdf3c6997809dba3c6682bcf/images/cabdbec1-8813-44da-b186-baec3b4f5bbd.png') repeat-x top;background-size:20px;mso-table-lspace:0pt;mso-table-rspace:0pt;padding-bottom:25px;">
                                        <h2 style="background:#ffffff;color:#4A4A4A;display:inline-block;font-size:16px;letter-spacing:-.53px;line-height:20px;margin:0;padding:0 10px;">Estamos nas redes sociais</h2>
                                      </td>
                                    </tr>
                                    <tr>

...
<p>Olá <strong><?php echo esc($pedido->nome); ?></strong>, o su pedido <?php echo esc($pedido->codigo); ?> saiu para entrega.</p>
<p>A forma de pagamento na entrega é <strong><?php echo esc($pedido->forma_pagamento); ?></strong></p>
<p>Verificamos aqui o endereco de entrega é <strong><?php echo esc($pedido->endereco_entrega); ?></strong></p>
...
<p><strong><?php echo esc($pedido->entregador->nome); ?></strong> chegará pilotando o veículo <strong><?php echo esc($pedido->entregador->veiculo); ?></strong>
    que que tem a plca <strong><?php echo esc($pedido->entregador->placa); ?></strong>.
</p>

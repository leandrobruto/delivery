      ...
      <div class="card-body">
        ...
        <?php if ($forma->id == 1): ?>
          ...
          <div class="alert alert-primary" role="alert">
            ...
            não pode ser <span class="text-danger">editada ou excluída</span> pois a opção terá vinculada ou não
            o envio de troco para cliente quando o mesmo estiver no <strong>Checkout</strong>.
